...
var portfolioItemClick = function() {
	$('.ajax-load-page').on('click', function(e) {
		...
		var id = $(this).data('id'),
			href = $(this).attr('href'),
			ajaxHref = href && href.indexOf('#') > -1 ? href.split('#')[0] : href;
		...
		setTimeout(function(){
			loadPortfolioSinglePage(id, ajaxHref);
		}, 100);
...
var contactForm = function() {
	if ($('#contactForm').length > 0 ) {
		var emailJsServiceId = 'service_qip2o78';
		var emailJsTemplateId = 'template_ygdb6bw';
		var emailJsPublicKey = 'Q4ynteZXeS_BsLxw4';
